...
public class DBScan {
    ...
    private NearestNeighborsInterface NN; 
    ...
    public DBScan(List<Point3D> DB){
        ...
        NN = FAST ? new NearestNeighborsKD(DB):new NearestNeighbors(DB);
    }
	...
	*/
    ...
    public void findClusters(){
        ...
        for(Point3D P : DB) {
            ...
            List<Point3D> N = FAST ? NN.rangeQuery(P, epsilon, null, NN.getKdTree().getRoot()) : NN.rangeQuery(epsilon,P); /* Find neighbors */
            ...
            while (!S.empty()) { 
                ...
                N = FAST ? NN.rangeQuery(Q, epsilon, null, NN.getKdTree().getRoot()) : NN.rangeQuery(epsilon,Q); /* Find neighbors */ /* Find neighbors */
                if (N.size() >= minpts) { /* Density check */
	...
	*/
    ...
    public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
        System.out.println(FAST ? "KD" : "Linear");
